      ...
      $sublist = \App\Category::whereis_del(0)->whereparent_id($item->id)->orderBy('id', 'desc')->get();
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control numberOnly" onkeyup="totamt({{ $uid }})" name="unit_price[]" id="unit_price{{ $uid }}" placeholder="Enter Price">
        ...
        <div class="col-sm-2">
            <div class="form-group">
                ...
                <input type="text" onkeyup="totamt({{ $uid }})" class="form-control numberOnly" name="qty[]" id="qty{{ $uid }}" placeholder="Enter Qty">
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <input type="text" onkeypress="return false" onkeydown="return false" class="form-control" name="t_amount[]" id="t_amount{{ $uid }}" placeholder="Enter Amount">
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" onkeyup="totamt({{ $uid }});" name="s_discount[]" id="s_discount{{ $uid }}" placeholder="Enter Scheme Discount">
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" onkeyup="totamt({{ $uid }});" name="gst[]" id="gst{{ $uid }}" placeholder="Enter GST">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="total_cost_price[]" id="total_cost_price{{ $uid }}" placeholder="Enter Cost Price">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="cost_price[]" id="cost_price{{ $uid }}" placeholder="Enter Cost Price">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="selling_price[]" id="selling_price{{ $uid }}" placeholder="Enter Selling Price">
