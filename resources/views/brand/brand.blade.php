            ...
            <div class="col-lg-12">
                ...
                <!-- Nav tabs -->
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#store">Brand's List &nbsp;
                                <i class="fa fa-thumbs-up"></i>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#addstore">Add Brand &nbsp;<i
                    ...
                    <div class="tab-content">
                        ...
                        <div id="addstore" class="tab-pane fade"><br>
                            <form action="{{ url('insert_brand') }}" method="GET" id="insert_store">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary pull-left">Create Brand &nbsp;<i
